...
const SkillsList = () => {
  ...
  const skills = {
    "Web Development": [
      "Full-stack web apps with Next.js & Tailwind CSS",
      "Modern Application with MCP servers",
      "Rag Chatbots Integration",
    ],
    "Backend": [
      "Prisma ORM with PostgreSQL/Neon/Supabase",
      "Authentication with BetterAuth, SupabaseAuth, Kinde and Clerk",
      "API development REST & FAST",
    ],
    "Working": [
      "Agent Native Cloud Development",
      "Dapr Kubernetes",
      "LangChain & AI tooling integration",
      "CrewAI Agent SDK (Chatbot)",
      "OpenAI agents SDK"
    ]
